...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<a class="navbar-brand" href="#">ALMEYDA SYSTEM</a>
		<ul class="nav navbar-nav">
			<li class=""><a href="reservation.php">
			<span class="glyphicon glyphicon-list" aria-hidden="true"></span>
			</a></li>
			<li class="active"><a href="transaction.php">Transacciones
			<span class="glyphicon glyphicon-usd" aria-hidden="true"></span>
			</a></li>
		</ul>
		<ul class="nav navbar-nav navbar-right">
	      <li><a href="../admin/logout.php"><span class="glyphicon glyphicon-log-out"></span> Iniciar Sesion</a></li>
	    </ul>
	</div>
</nav>
<br />
